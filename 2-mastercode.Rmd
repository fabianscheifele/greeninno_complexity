...
length(obs_tochange$appln_id)/length(y2_final95_distinct$appln_id)
...
#Change wrong CPC codes (i.e. subgroups that do not exist)
...
#Replace the remaining 13 codes
...
y2_final95_distinct$cpc_updated[y2_final95_distinct$cpc_updated=="Y02B50/14"]<-"Y02T50/10"
