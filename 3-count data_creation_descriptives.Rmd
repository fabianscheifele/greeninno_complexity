...
#median is 131 families per count(over the whole period!

length(unique(pat_count$person_ctry_code))
#205 countries

length(unique(pat_count$cpc))
#432 different Y02 cpc tags
```


7. Filter out 2020/2021 and countries and CPC that have been infrequently filed
```{r}
...
length(unique(cpcs$cpc))/length(unique(pat_count_balanced_filled$cpc))
#212 out of 432 CPC codes have at least one year where no family is filled
#even after 2020 and 2021 were excluded
